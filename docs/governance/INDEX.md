...
| `OPEN_DECISIONS_2026-08-25.md` | **CANONICAL** | The live decision register: every item that needs a person, with what was verified and what it costs to be wrong. Read this before planning a session; retire each entry as it is decided. D-01 through D-10 were resolved 2026-08-25 and are retained there as the record of why; **D-11 is open** (near-miss abstention is not decidable by any lexical threshold, raised by the M1-3 scale-up). Add new decisions to this register rather than starting a fresh one. |
