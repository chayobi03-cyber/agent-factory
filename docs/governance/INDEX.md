...
| `OPEN_DECISIONS_2026-08-25.md` | **CANONICAL** | The live decision register: every item that needs a person, with what was verified and what it costs to be wrong. Read this before planning a session; retire each entry as it is decided. Six of nine entries were resolved 2026-08-25 and are retained there as the record of why. `D-05`/`D-06` need remote ref deletion (403 from an agent session — run locally) and `D-08` is the owner's call. |
