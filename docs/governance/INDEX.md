...
| `OPEN_DECISIONS_2026-08-25.md` | **CANONICAL** | The live decision register: every item that needs a person, with what was verified and what it costs to be wrong. Read this before planning a session; retire each entry as it is decided. Eight of nine entries were resolved 2026-08-25 and are retained there as the record of why. Only `D-08` — this repository's public visibility — remains, and it is the owner's call. |
